# Constraint file for Multi-Timer Digital Stopwatch on EGO1 FPGA Board
# Enhanced version with 2 independent timers and lap timing
...
# Timer 1 indicator LED (M1)
set_property IOSTANDARD LVCMOS33 [get_ports led_t1]
set_property PACKAGE_PIN M1 [get_ports led_t1]

# Timer 2 indicator LED (L1)
set_property IOSTANDARD LVCMOS33 [get_ports led_t2]
set_property PACKAGE_PIN L1 [get_ports led_t2]
